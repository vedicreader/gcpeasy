"""Compute Engine (GCE), Google Kubernetes Engine (GKE), Artifact Registry,
Cloud Run, and Cloud Build (image build / push) helpers."""

# Hand-edited; not nbdev-generated. See PLAN.md note.

__all__ = [
    'create_instance', 'instance_ip', 'start_instance', 'stop_instance',
    'delete_instance',
    'create_gke_cluster', 'gke_kubeconfig', 'scale_gke',
    'create_artifact_registry', 'registry_url', 'attach_registry_to_gke',
    'delete_artifact_registry',
    'deploy_cloudrun', 'cloudrun_url', 'delete_cloudrun',
    'cloudrun_domain_mapping',
    'build_image_cloudbuild', 'push_image',
